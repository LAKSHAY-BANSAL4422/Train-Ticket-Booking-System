...
public:
    ...
    void retranslateUi(QDialog *Startup)
    {
        ...
        uid_register->setPlaceholderText(QCoreApplication::translate("Startup", "Enrollment Number", nullptr));
        ...
        yfield_register->setPlaceholderText(QCoreApplication::translate("Startup", "Year Of Passing", nullptr));
        ...
        uid_login->setPlaceholderText(QCoreApplication::translate("Startup", "Enrollment Number", nullptr));
