...
namespace {
struct qt_meta_tag_ZN10bookticketE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN10bookticketE = QtMocHelpers::stringData(
    "bookticket",
...
Q_CONSTINIT static const uint qt_meta_data_ZN10bookticketE[] = {
...
Q_CONSTINIT const QMetaObject bookticket::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10bookticketE.offsetsAndSizes,
    qt_meta_data_ZN10bookticketE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10bookticketE_t,
        // Q_OBJECT / Q_GADGET
...
void *bookticket::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10bookticketE.stringdata0))
