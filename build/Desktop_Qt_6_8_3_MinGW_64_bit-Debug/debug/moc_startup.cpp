...
namespace {
struct qt_meta_tag_ZN7StartupE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN7StartupE = QtMocHelpers::stringData(
    "Startup"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN7StartupE[] = {
...
Q_CONSTINIT const QMetaObject Startup::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_ZN7StartupE.offsetsAndSizes,
    qt_meta_data_ZN7StartupE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7StartupE_t,
        // Q_OBJECT / Q_GADGET
...
void *Startup::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7StartupE.stringdata0))
